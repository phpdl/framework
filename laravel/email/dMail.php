...
* @example
  ...
  $mail = new DMail();
	...
	$mail->setServer("smtp.qq.com", "发送人账号", "发送人密码或授权码",25,false); //设置smtp服务器，普通连接方式

 $mail->setServer("smtp.qq.com", "1918347532@qq.com", "gjtuorgsakmieijc", 465, true); //设置smtp服务器，到服务器的SSL连接

 $mail->setFrom("1918347532@qq.com"); //设置发件人

 $mail->setReceiver("584271086@qq.com"); //设置收件人，多个收件人，调用多次

 //$mail->setCc("354174199@qq.com"); //设置抄送，多个抄送，调用多次

 $mail->setBcc("354174199@qq.com"); //设置秘密抄送，多个秘密抄送，调用多次
...
public function setServer($server='smtp-n.global-mail.cn', $username="xxxmama@dongliedu.com", $password="xxx41225", $port=465, $isSecurity=true) {
